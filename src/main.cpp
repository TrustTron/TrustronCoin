...
static unsigned int nStakeMinAgeV1 = 24 * 60 * 60;
static unsigned int nStakeMinAgeV2 = 24 * 60 * 60; 
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if(IsTreasuryBlock(nHeight)) {
	    ...
	    if (nHeight == 0) {
			...
			nSubsidy = 10 * COIN;
	    } else if(nHeight > 210000 && nHeight <= 814151) { 
			nSubsidy = 2 * COIN;
	    } else {
	        nSubsidy = 1 * COIN;
	    }
